    ...
    <div class="container">
        <fieldset>
            ...
            <form action="" method="get" id="form-contato" class="">
                ...
                <div class="" style="width: 100%;">
                    ...
                    <div style="width: 100%; display: flex; flex-direction: row; justify-content: space-between;">
                        ...
                        <a href="indexcli.php" class="btn btn-primary">Ver Todos</a>
                    </div>
                </div>
            ...
            <div style="width: 100%; display: flex; flex-direction: row; justify-content: space-between;">
                ...
                <a href="cadastro.php" class="btn btn-success">Cadastrar Cliente</a>
                <!-- link para imprimir -->
                <a href="imprimircli.php"><button class="btn btn-danger">Imprimir</button></a>
            </div>
    ...
    <div class="container">
        <footer class="py-3 my-4">
          <ul class="nav justify-content-center border-bottom pb-3 mb-3">
            ...
            <li class="nav-item"><a href="#" class="nav-link px-2 text-body-secondary">Clientes</a></li>
